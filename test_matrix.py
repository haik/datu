...
dim = 1
a1 = np.random.randint(0, 100, size=(4039,4039))
a2 = np.random.randint(0, 100, size=(4039,4039))
b1 = np.random.randint(0, 100, size=(4039,))
b2 = np.random.randint(0, 100, size=(4039,))
t2 = time.time()
