...
def HouseholderSs(matrix1, matrix2):		# Householder transformation
	...
	for i in range(size):
		...
		u1 = R1[i:,i]
		u2 = R2[i:,i]
		temp1, temp2, toff1, ton1 = InnerProductss(u1, u2, u1, u2)
		temp11, temp12, toff2, ton2 = isqrtss(temp1, temp2)
		temp1, temp2, toff4, ton4 = NumProductss(temp1, temp2, temp11, temp12)
		u1[0] -= temp1
		u2[0] -= temp2
		
		beta1, beta2, toff3, ton3 = InnerProductss(u1, u2, u1, u2)
		# beta1, beta2, toff4, ton4 = sqrtss(beta1, beta2)
		if beta1+beta2<0.00001:
